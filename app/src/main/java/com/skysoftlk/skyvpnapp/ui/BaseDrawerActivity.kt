package com.skysoftlk.skyvpnapp.ui
        ...
        when (menuId) {
            R.id.nav_home -> {
                if (this !is MainActivity) {
                    val intent = Intent(this, com.skysoftlk.skyvpnapp.Activities.MainActivity::class.java)
                    intent.flags = Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_SINGLE_TOP
                    startActivity(intent)
                }
            }
            R.id.nav_servers -> {
                startActivity(Intent(this, com.skysoftlk.skyvpnapp.Activities.Servers::class.java))
            }
            R.id.nav_premium -> {
                startActivity(Intent(this, com.skysoftlk.skyvpnapp.Activities.UnlockAllActivity::class.java))
            }
            R.id.nav_helpus -> {
